package com.mobile263.mobile.nethall.config;
...
public class Constants {
	...
	// 保存参数文件夹名称
	public static final String SHARED_PREFERENCE_NAME = "mobile263_mobile_nethall";

	// SDCard路径
	public static final String SD_PATH = Environment
			.getExternalStorageDirectory().getAbsolutePath();

	// 图片存储路径com.mobile263.mobile.nethall.ui
	public static final String BASE_PATH = SD_PATH + "/mobile263/mobile/nethall/";
